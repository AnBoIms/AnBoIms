from image_processing import crop_and_transform_object, insert_image_final, crop_text_regions, adjust_polygon
        ...
        for obj in selected_objects:
            if obj["type"] == "sign":
                ...
                for region in obj["text_regions"]:
                    ...
                    original_polygon = region["polygon"]
                    reordered_polygon = adjust_polygon(original_polygon)
                        
                success = insert_image_final(cropped_img, text_img,reordered_polygon)
                if success:
